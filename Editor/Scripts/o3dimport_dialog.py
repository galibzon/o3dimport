...
"""
# -------------------------------------------------------------------------
"""o3dimport\\editor\\scripts\\o3dimport_dialog.py
Generated from O3DE PythonToolGem Template"""

from PySide2.QtCore import Qt
from PySide2.QtWidgets import QDialog, QLabel, QVBoxLayout

class o3dimportDialog(QDialog):
    def __init__(self, parent=None):
        super(o3dimportDialog, self).__init__(parent)
...
if __name__ == "__main__":
    ...
    test_dialog = o3dimportDialog()
    test_dialog.setWindowTitle("o3dimport")
    test_dialog.show()
